...
from src.utils import save_object, get_best_model_name, get_train_and_test_arrays
...
class Model_Trainer:
    ...
    def evaluate_models(self, x_train:np.ndarray, y_train:np.ndarray, models:dict)-> Dict:
        ...
        try:
            ...
            # trained_models_report_fields = [CVAL_R2_SCORE, OVERFIT_GAP, CVAL_R2_SCORE_STD]
